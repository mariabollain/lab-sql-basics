...
SELECT COUNT(DISTINCT client_id),  district_id FROM client
WHERE district_id < 10
GROUP BY district_id
ORDER BY COUNT(DISTINCT client_id) asc;
...
SELECT account_id, 
SUM(CASE WHEN  type = "PRIJEM" THEN ROUND(amount) END) AS "incoming amount",
SUM(CASE WHEN type = "VYDAJ" THEN ROUND(amount) END) AS "outgoing amount",
